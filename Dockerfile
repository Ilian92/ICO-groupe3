...
CMD bash -c "composer require symfony/orm-pack && composer install && composer require symfony/twig-bundle && composer require symfony/twig-bundle && php -S 0.0.0.0:8000 -t public"